  ...
  <div class="modal-overlay" @click.self="$emit('close')">
    <div class="modal-card" style="max-width: 560px">
        ...
        >
          ...
          <div style="display: flex; gap: 0.5rem">
            ...
            <button
              class="btn danger"
              @click="clear"
              :disabled="cart.loading || cart.count === 0"
            >
              Töm
            </button>
          </div>
      ...
      <div class="row" style="gap: 1rem">
        ...
        >
          ...
          <div>
            ...
            <div class="card-sub" style="font-size: 0.75rem">
              ...
              <template v-else>
                Hyra – {{ it.rental_months }} mån ×
                {{ it.price_rent_per_month }} kr/mån =
                <strong
                  >{{ it.rental_months * it.price_rent_per_month }} kr</strong
                >
              </template>
            </div>
          </div>
        ...
        <div v-if="cart.count > 0" class="row" style="gap: 0.5rem">
          <div class="card-sub">
            <strong>Summa:</strong> {{ cart.total }} kr
          </div>
          <button
            class="btn primary"
          ...
          <p v-if="err" style="color: #fca5a5; font-size: 0.8rem; margin: 0">
            {{ err }}
          </p>
